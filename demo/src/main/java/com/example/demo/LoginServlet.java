...
// Вывести форму
        pw.println("<form action='/demo_war_exploded/' method='post'>Write your name: <input type='text' name='name' value=''><input type='submit' value='Enter chat'>");
...
// Извиниться, отказать и попросить ввести другое имя
            return "Извините, но имя <strong>" + name + "</strong> ужe кем-то занято. Пожалуйста выберите другое имя!";
        }
    }
}
